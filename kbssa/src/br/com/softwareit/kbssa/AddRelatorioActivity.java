...
public class AddRelatorioActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final EditText intensidadeText = (EditText) findViewById(R.id.intensidade_text);
		...
		saveButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Integer intensidade = Integer.parseInt(intensidadeText.getEditableText().toString());
				Date data = new Date();
